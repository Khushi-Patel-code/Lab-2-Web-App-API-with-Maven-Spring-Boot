...
public class BinaryAPIControllerTest {
    ...
    public void add2() throws Exception {
        this.mvc.perform(get("/add_json").param("operand1","111").param("operand2","1010"))
			...
			.andExpect(MockMvcResultMatchers.jsonPath("$.operator").value("+"));
    }
    @Test
    public void apiMultiplyTest() throws Exception {
        this.mvc.perform(get("/add").param("operand1","111").param("operator","*").param("operand2","10"))
            .andExpect(status().isOk())
